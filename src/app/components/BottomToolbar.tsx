...
function BottomToolbar({
  ...
  return (
    <div className="p-4 flex flex-row items-center justify-center gap-x-4 flex-wrap">
      <button
      ...
      {isAudioPlaybackEnabled && (
        <div className="flex flex-row items-center gap-2">
          <label htmlFor="voice-select" className="flex items-center cursor-pointer whitespace-nowrap">
            Voice:
          </label>
          <div className="relative inline-block">
            ...
            >
              ...
              <option value="RR Mila">RR Mila (Indonesian)</option>
              <option value="Afifah">Afifah (Malay)</option>
            </select>
